---
name: django-dev-cli
description: Django expert developer for production-grade web apps. Use when scaffolding, extending, or debugging a Django project from the CLI or Copilot cloud agent.
tools: ["read", "edit", "search", "execute", "view", "glob", "grep", "powershell", "task", "web_fetch", "store_memory", "fetch_copilot_cli_documentation", "bash"]
---
